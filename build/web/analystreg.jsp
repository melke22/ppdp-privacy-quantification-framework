    ...
    <div class="workzone-left">
      <div>
        ...
        <br><center>
           ...
           <form name="myform" id="loginForm" action="analystregact.jsp" method="post"  onsubmit="return validateform()" >        
                
          
         <table border="0" >
             <font color="black" size="5">Analyst Registration</font></h2> 
             <br><br>
         ...
         <tr rowspan="2" align="center"><td><br><input type="submit" name="submit" value="    Register    " /></td></tr>
         <tr></tr>      
         </table>
