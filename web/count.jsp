...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
        ...
        <%
          Connection con = null;
                                ...
                                String query1="delete from ldiversity"; 
		   		...
		   		//String msg="Record deleted successfully";
                               ...
                               /* L- Diversity Starts */  
                                ...
                                con = databasecon.getconnection();
                                   ...
                                   rs = st.executeQuery("select * from anonypatient");
                         try {           
                              while(rs.next())
                              {
    ...
    pstm = con.prepareStatement("insert into ldiversity (pid,pname, blood, disease,email,mobile,city,dob,age,address,gender,zipcode,groupid,year)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                        ...
                        pstm.setString(11, y);
                        pstm.setString(12, star);
                        pstm.setString(14, year);
                                  ...
                                  {
                                  male = "1";
                                   pstm.setString(13, male);
                                  }
                                   else
                                  {
                                     female = "2"; 
                                      pstm.setString(13, female);
                                  }
                              ...
                              if (i == 1) {
                                    response.sendRedirect("ldiversity.jsp?msg=success");
                              }
