...
try{ 
	...
	PreparedStatement pst=con.prepareStatement("select * from patientdetails ");
...
        <th><font color="red">Blood Group</font></th>
        <th><font color="red">Disease</font></th>
        ...
        <th><font color="red">Update</font></th>
	...
	while(rs.next()){
            %><tr><th><%=rs.getString("pid")%></th>
                ...
                <th><%=rs.getString("gender")%></th>
                 ...
                 <th><a href="dupdate.jsp?pid=<%=rs.getString("pid")%>"><font color="black">Update</font></a></th>
